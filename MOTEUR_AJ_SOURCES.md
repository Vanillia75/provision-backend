...
- ✅ **BACKTEST MENSUEL — cas réel n°1 (2026-07-04)** : décomptes réels octobre + novembre 2025 (annexe 10, AJ brute 51,93 € avant la revalorisation du 25/11 → 52,43 €).
  ...
  - **Prochain juge** : décompte de **juillet 2026** (cas réel n°1, réindemnisée depuis le 27/06/2026 ; notification du 03/07 : AJ 51,18 €, franchises congés payés mentionnées), dispo **début août 2026**. **(MAJ 04/08 : la branche « mois travaillé » a finalement été validée par le cas réel n°4, voir plus bas. Le décompte du cas n°1 reste précieux pour valider les FRANCHISES congés payés, non couvertes par le n°4.)**
...
- 🏆 **BACKTEST MENSUEL « MOIS TRAVAILLÉ » — cas réel n°4, annexe 10 (2026-08-04) : EXACT AU CENTIME.**
  Attestation de paiement FT du 03/08/2026 : **996,38 € versés pour la période du 10 au
  31 juillet 2026**. Données du mois, saisies dans l'app AVANT réception du décompte :
  **6 cachets isolés en juillet (72 h)**, AJ du profil **45,29 €**.
  - Moteur (`estimer_mois_civil`, annexe 10, sans franchises) : décalage (72 ÷ 10) × 1,3
    = 9,36 → **9 jours non indemnisables (troncature confirmée)** ; 31 − 9 = **22 jours** ;
    22 × 45,29 = **996,38 €** ✓✓. Reproduit par un test permanent (`test_franchises_mois.py`
    ou dédié) et rejoué le 04/08 sur les données réelles.
  - Le paiement démarre le 10/07 : les jours non indemnisables sont bien placés **en début
    de mois** par France Travail ✓.
  - **Verdict Loi X : la branche « mois travaillé », non reproduite depuis l'échec de
    novembre 2025 (cas n°1), est VALIDÉE sur un décompte réel.**
  - Non couvert par ce cas : CSG écrêtée (AJ < plancher 62 €), franchises (aucune déclarée
    ni déduite), plafond de cumul (loin), PAS (non déduit de ce versement).
